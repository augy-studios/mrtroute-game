...
each channel, the question cards as sent, and the name each player last
...
-- players' runs at once. A button from any other run is refused.
...
# The run each player is playing, per channel.
